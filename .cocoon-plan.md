...
- **142 个单元测试全部通过**（Unity 框架）
- **80 项集成测试全部通过**（新增 3 项反向代理测试）
...
- 配置文件支持：JSON 格式，14 个字段（含 `proxies` 数组），命令行参数可覆盖
...
5. **[x] 插件热重载** — 运行时 SIGUSR1 触发重新加载插件 ✅ 2026-06-06
6. **[x] CI 自动化** — GitHub Actions 编译 + 测试 ✅ 2026-06-06
7. **[x] Makefile 测试目标完善** — integration-test 别名 + test-all ✅ 2026-06-06
8. **[x] README 同步更新** — 补充所有新功能与 CI badge ✅ 2026-06-06
